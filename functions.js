...
console.log(stringsLongerThan(['say', 'hello', 'in', 'the', 'morning'], 3)); // returns ['hello' , 'morning']
console.log(stringsLongerThan(['say', 'hello', 'in', 'the', 'morning'], 5)); // returns ['morning]
console.log(stringsLongerThan(['say', 'hello', 'in', 'the', 'morning'], 7)); // returns []